...
int main(void) 
{
    ...
    while (true) {	
        ...
        if (sd != INVALID_SOCKET) {
			...
			send(sd, "1. la temperature qu'il fera a une heure de la journee courante", 100, 0);
			send(sd, "2. l'heure du coucher du soleil dans la journee en cours", 100, 0);
			send(sd, "3. l'heure de levee de soleil a la prochaine journee", 100, 0);
			send(sd, "4. la possibilite qu'il pleuve ou non dans la journee", 100, 0);
			send(sd, "5. la possibilite qu'il pleuve ou non la prochaine journee", 100, 0);
			send(sd, "6. la possibilite qu'il neige ou non dans la journee", 100, 0);
			send(sd, "7. la possibilite qu'il neige ou non la prochaine journee", 100, 0);
